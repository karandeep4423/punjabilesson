...
const Reschedule = () => {
  ...
  return (
    <div>
      <Head>
        <title>Reschedule or Cancel Lesson - Punjabi Lesson</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta
          name="description"
          content="Cancel your lesson reservation when necessary. Manage your lesson reservations and ensure your schedule aligns with your needs."
        />
      </Head>
