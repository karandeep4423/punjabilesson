...
const Book_lesson = () => {
  ...
  return (
    <div>
      <Head>
        <title>Select Date and Time - Punjabi Lesson.</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta
          name="description"
          content="Select a date for your lesson and plan your schedule. Choose a convenient time that works for you and get ready for an exciting learning experience."
        />
      </Head>
            ...
            <div className="flex  mt-10 justify-center">
              <Link
                href={{
                  pathname: "/checkout",
                  query: {
                    packId: encodeURIComponent(router.query.packId || ""),
                    lesson: encodeURIComponent(router.query.lesson || ""),
                    schdule: encodeURIComponent(
                      format(selectedSlot, "EEEE, MMMM d HH:mm zzz")
                    ),
                    timezone: encodeURIComponent(selectedOption || ""),
                  },
                }}
              >
